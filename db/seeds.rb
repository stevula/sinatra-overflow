...
user_one_post.answers << Post.create(post_type: "answer", body: Faker::Hacker.say_something_smart, best_answer: false, author_id: 2, question_id: 1)
...
user_one_post.answers << Post.create(post_type: "answer", body: Faker::Hacker.say_something_smart, best_answer: false, author_id: 3, question_id: 1)
